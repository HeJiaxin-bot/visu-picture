...
//            }
    ...
    @PostMapping("/ai_edit")
    @SaSpaceCheckPermission(value = SpaceUserPermissionConstant.PICTURE_EDIT)
    public BaseResponse<PictureAiEditResult> aiEditPicture(@RequestBody PictureAiEditRequest pictureAiEditRequest,
                                                           HttpServletRequest request) {
        ThrowUtils.throwIf(pictureAiEditRequest == null || pictureAiEditRequest.getPictureId() == null,
